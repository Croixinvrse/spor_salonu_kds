...
app.get('/uyeler', (req, res) => {
    dbConn.query("SELECT * FROM uye,sube,uye_kurs,kurs WHERE uye.sube_id = sube.sube_id AND uye.uye_id = uye_kurs.uye_id AND kurs.kurs_id = uye_kurs.kurs_id", (error, results) => { 
